...
CREATE TABLE IF NOT EXISTS jobs (
  ...
  dditional_notes TEXT DEFAULT NULL,
...
ame) 
VALUES ('admin', '.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'CEGS Administrator')
ON DUPLICATE KEY UPDATE username=username;

-- ----------------------------------------------------------------------------
-- 4. Seed Initial Sample Job Postings
-- ----------------------------------------------------------------------------
INSERT INTO jobs (company_name, job_role, salary, qualification, language_required, shift_details, location, cab_facility, dditional_notes, posted_date) VALUES
